# Action Detection on Local Machine
...
mp_holistic = mp.solutions.holistic     # bringing in holistic model
...
def mediapipe_detection(image, model):
    ...
    image = cv2.cvtColor(image, cv2.COLOR_RGB2BGR)  # colour conversion back
